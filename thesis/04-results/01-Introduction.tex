...
\begin{table}[h]
    ...
    \begin{tabular}{@{}cccc@{}}
        ...
        \midrule
        standard            & $\hat{H}_\mathrm{M}$   & $\hat{H}_\mathrm{QP}$ & $\langle \hat{H}_\mathrm{QP} \rangle$ \\
        linear\_quadratic   & $\hat{H}_\mathrm{M}$   & $\hat{H}_\mathrm{LP}$ & $\langle \hat{H}_\mathrm{QP} \rangle$ \\
        linear\_abs         & $\hat{H}_\mathrm{M}$   & $\hat{H}_\mathrm{LP}$ & $\langle |\hat{H}_\mathrm{LP}| \rangle$ \\
        \bottomrule
    \end{tabular}
