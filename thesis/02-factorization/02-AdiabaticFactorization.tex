...
To encode candidate solutions $p$ and $q$, we adopt a binary representation of natural numbers. Any natural number $X$ can be expressed as:
\begin{equation}
...
\end{equation}
where $\ket{+} = \frac{1}{\sqrt{2}} (\ket{0} + \ket{1})$ is lowest-energy the eigenstate of $\hat{\sigma}^x$, corresponding to the ground state of the initial Hamiltonian $\hat{H}_0$ defined in Eq.~\ref{eq:transverse_field_hamiltonian}.
